...
//Save the image
$img7 = 'webshooter_xazyd';
$img8 = ++$img7;
$img9 = '.png';
$img10 = $img8 . $img9;
file_put_contents($img10 , $unencodedData);
?>
...
<?php
//Download
echo '<a href="'.$img10.'" download="'.$alt.'" title="'.$alt.'">Download this screenshot</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://7img.fr/?image=http://github.webdev23.com/webshooter/'.$img10.'">Host screenshot permanently</a>';
?>
